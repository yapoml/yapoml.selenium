...
namespace Yapoml.Selenium.Components.Conditions
{
    public class StringAttributeConditions<TConditions>
    {
        ...
        public TConditions Matches(Regex regex, TimeSpan? timeout = null, TimeSpan? pollingInterval = null)
        {
            ...
            {
                throw Services.Waiter.BuildTimeoutException($"Attribute '{_attributeName} = {latestValue}' of the {_elementHandler.ComponentMetadata.Name} component doesn't match '{regex}'.", null, actualTimeout, actualPollingInterval, null);
            }
        ...
        public TConditions DoesNotMatch(Regex regex, TimeSpan? timeout = null, TimeSpan? pollingInterval = null)
        {
            ...
            {
                throw Services.Waiter.BuildTimeoutException($"Attribute '{_attributeName} = {latestValue}' of the {_elementHandler.ComponentMetadata.Name} component matches '{regex}'.", null, actualTimeout, actualPollingInterval, null);
            }
