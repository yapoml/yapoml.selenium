...
namespace Yapoml.Selenium.Services.Factory
{
    ...
    {
        public TComponent Create<TComponent, TConditions>(IWebDriver webDriver, IElementHandler elementHandler, ComponentMetadata componentMetadata, ISpaceOptions spaceOptions) where TComponent : BaseComponent<TComponent, TConditions>
        {
